...
enum eStructsConsts {
    ...
    VAP_LABEL_MAX_LENGTH      = 64 + 1 + 3, //need extra 1 byte for null termination + alignment
    MMPDU_MAX_LENGTH          = 2304,
    DPP_FRAME_MAX_LEN         = 2 * MMPDU_MAX_LENGTH + 1, // hex-encoded frame + null termination
