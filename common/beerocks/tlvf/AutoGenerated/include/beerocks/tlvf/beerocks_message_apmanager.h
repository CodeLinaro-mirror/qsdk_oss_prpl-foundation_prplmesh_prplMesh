...
class cACTION_APMANAGER_HOSTAP_AP_ENABLED_NOTIFICATION : public BaseClass
{
    public:
        ...
        sVapInfo& vap_info();
        int8_t& mld_unit();
        std::string configured_ssid_str();
        char* configured_ssid(size_t length = 0);
        bool set_configured_ssid(const std::string& str);
        bool set_configured_ssid(const char buffer[], size_t size);
        void class_swap() override;
        bool finalize() override;
        static size_t get_initial_size();
    ...
    private:
        ...
        char* m_configured_ssid = nullptr;
        size_t m_configured_ssid_idx__ = 0;
        int m_lock_order_counter__ = 0;
};
...
class cACTION_APMANAGER_HOSTAP_CHANNEL_SWITCH_ACS_START : public BaseClass
{
    public:
        ...
        sEhtOperationParams& eo_params();
        int8_t& tx_limit();
        uint8_t& tx_limit_valid();
        uint8_t& spatial_reuse_valid();
        uint8_t& eht_operation_valid();
        void class_swap() override;
        bool finalize() override;
        static size_t get_initial_size();
    ...
    private:
        ...
        sEhtOperationParams* m_eo_params = nullptr;
        int8_t* m_tx_limit = nullptr;
        uint8_t* m_tx_limit_valid = nullptr;
        uint8_t* m_spatial_reuse_valid = nullptr;
        uint8_t* m_eht_operation_valid = nullptr;
};

class cACTION_APMANAGER_PLATFORM_ACS : public BaseClass
{
    public:
        cACTION_APMANAGER_PLATFORM_ACS(uint8_t* buff, size_t buff_len, bool parse = false);
        explicit cACTION_APMANAGER_PLATFORM_ACS(std::shared_ptr<BaseClass> base, bool parse = false);
        ~cACTION_APMANAGER_PLATFORM_ACS();

        static eActionOp_APMANAGER get_action_op(){
            return (eActionOp_APMANAGER)(ACTION_APMANAGER_PLATFORM_ACS);
        }
        bool isPostInitSucceeded() override;
...
class cACTION_APMANAGER_HOSTAP_SERVICE_PRIO_CONFIG : public BaseClass
{
    public:
        cACTION_APMANAGER_HOSTAP_SERVICE_PRIO_CONFIG(uint8_t* buff, size_t buff_len, bool parse = false);
        explicit cACTION_APMANAGER_HOSTAP_SERVICE_PRIO_CONFIG(std::shared_ptr<BaseClass> base, bool parse = false);
        ~cACTION_APMANAGER_HOSTAP_SERVICE_PRIO_CONFIG();

        static eActionOp_APMANAGER get_action_op(){
            return (eActionOp_APMANAGER)(ACTION_APMANAGER_HOSTAP_SERVICE_PRIO_CONFIG);
        }
...
class cACTION_APMANAGER_WIFI_CREDENTIALS_UPDATE_REQUEST : public BaseClass
{
    public:
        ...
        uint8_t& report_teardown_completion();
    ...
    private:
        bool init();
        eActionOp_APMANAGER* m_action_op = nullptr;
        uint8_t* m_report_teardown_completion = nullptr;
...
{
    public:
        cACTION_APMANAGER_WIFI_CREDENTIALS_UPDATE_RESPONSE(uint8_t* buff, size_t buff_len, bool parse = false);
        explicit cACTION_APMANAGER_WIFI_CREDENTIALS_UPDATE_RESPONSE(std::shared_ptr<BaseClass> base, bool parse = false);
        ~cACTION_APMANAGER_WIFI_CREDENTIALS_UPDATE_RESPONSE();

        static eActionOp_APMANAGER get_action_op(){
            return (eActionOp_APMANAGER)(ACTION_APMANAGER_WIFI_CREDENTIALS_UPDATE_RESPONSE);
        }
        uint8_t& number_of_bss_available();
        void class_swap() override;
        bool finalize() override;
        static size_t get_initial_size();
    ...
    private:
        bool init();
        eActionOp_APMANAGER* m_action_op = nullptr;
        uint8_t* m_number_of_bss_available = nullptr;
};

class cACTION_APMANAGER_BSS_TEARDOWN_RESPONSE : public BaseClass
{
    public:
        cACTION_APMANAGER_BSS_TEARDOWN_RESPONSE(uint8_t* buff, size_t buff_len, bool parse = false);
        explicit cACTION_APMANAGER_BSS_TEARDOWN_RESPONSE(std::shared_ptr<BaseClass> base, bool parse = false);
        ~cACTION_APMANAGER_BSS_TEARDOWN_RESPONSE();

        static eActionOp_APMANAGER get_action_op(){
            return (eActionOp_APMANAGER)(ACTION_APMANAGER_BSS_TEARDOWN_RESPONSE);
        }
        uint8_t& success();
        void class_swap() override;
        bool finalize() override;
...
class cACTION_APMANAGER_RADIO_ENABLE_REQUEST : public BaseClass
{
    public:
        cACTION_APMANAGER_RADIO_ENABLE_REQUEST(uint8_t* buff, size_t buff_len, bool parse = false);
        explicit cACTION_APMANAGER_RADIO_ENABLE_REQUEST(std::shared_ptr<BaseClass> base, bool parse = false);
        ~cACTION_APMANAGER_RADIO_ENABLE_REQUEST();

        static eActionOp_APMANAGER get_action_op(){
            return (eActionOp_APMANAGER)(ACTION_APMANAGER_RADIO_ENABLE_REQUEST);
        }
        void class_swap() override;
        bool finalize() override;
        static size_t get_initial_size();
...
class cACTION_APMANAGER_MULTI_CHAN_BEACON_11K_REQUEST : public BaseClass
{
    public:
        cACTION_APMANAGER_MULTI_CHAN_BEACON_11K_REQUEST(uint8_t* buff, size_t buff_len, bool parse = false);
        explicit cACTION_APMANAGER_MULTI_CHAN_BEACON_11K_REQUEST(std::shared_ptr<BaseClass> base, bool parse = false);
        ~cACTION_APMANAGER_MULTI_CHAN_BEACON_11K_REQUEST();

        static eActionOp_APMANAGER get_action_op(){
            return (eActionOp_APMANAGER)(ACTION_APMANAGER_MULTI_CHAN_BEACON_11K_REQUEST);
        }
        sMacAddr& sta_mac();
        uint16_t& timeout();
        void class_swap() override;
...
{
    public:
        cACTION_APMANAGER_MLD_MODE_UPDATE_REQUEST(uint8_t* buff, size_t buff_len, bool parse = false);
        explicit cACTION_APMANAGER_MLD_MODE_UPDATE_REQUEST(std::shared_ptr<BaseClass> base, bool parse = false);
        ~cACTION_APMANAGER_MLD_MODE_UPDATE_REQUEST();

        static eActionOp_APMANAGER get_action_op(){
            return (eActionOp_APMANAGER)(ACTION_APMANAGER_MLD_MODE_UPDATE_REQUEST);
        }
        std::string ssid_str();
        char* ssid(size_t length = 0);
        bool set_ssid(const std::string& str);
...
class cACTION_APMANAGER_QOS_MANAGEMENT_POLICY_REQUEST : public BaseClass
{
    public:
        cACTION_APMANAGER_QOS_MANAGEMENT_POLICY_REQUEST(uint8_t* buff, size_t buff_len, bool parse = false);
        explicit cACTION_APMANAGER_QOS_MANAGEMENT_POLICY_REQUEST(std::shared_ptr<BaseClass> base, bool parse = false);
        ~cACTION_APMANAGER_QOS_MANAGEMENT_POLICY_REQUEST();

        static eActionOp_APMANAGER get_action_op(){
            return (eActionOp_APMANAGER)(ACTION_APMANAGER_QOS_MANAGEMENT_POLICY_REQUEST);
        }
        void class_swap() override;
        bool finalize() override;
        static size_t get_initial_size();
...
class cACTION_APMANAGER_BSS_SET_QOS_MANAGEMENT_REQUEST : public BaseClass
{
    public:
        cACTION_APMANAGER_BSS_SET_QOS_MANAGEMENT_REQUEST(uint8_t* buff, size_t buff_len, bool parse = false);
        explicit cACTION_APMANAGER_BSS_SET_QOS_MANAGEMENT_REQUEST(std::shared_ptr<BaseClass> base, bool parse = false);
        ~cACTION_APMANAGER_BSS_SET_QOS_MANAGEMENT_REQUEST();

        static eActionOp_APMANAGER get_action_op(){
            return (eActionOp_APMANAGER)(ACTION_APMANAGER_BSS_SET_QOS_MANAGEMENT_REQUEST);
        }
        sMacAddr& bssid();
        uint8_t& mscs_enable();
        uint8_t& scs_enable();
