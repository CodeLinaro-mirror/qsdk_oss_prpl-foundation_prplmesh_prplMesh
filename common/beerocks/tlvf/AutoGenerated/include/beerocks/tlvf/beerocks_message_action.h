...
enum eActionOp_CONTROL: uint8_t {
    ...
    ACTION_CONTROL_BSS_SET_QOS_MANAGEMENT_REQUEST = 0x4a,
...
enum eActionOp_BACKHAUL: uint8_t {
    ...
    ACTION_BACKHAUL_PLATFORM_ACS = 0x34,
    ...
    ACTION_BACKHAUL_TRIGGER_ON_BOOT_SCAN = 0x52,
    ACTION_BACKHAUL_WIFI_CREDENTIALS_UPDATE_REQUEST = 0x53,
    ACTION_BACKHAUL_WIFI_ENABLE_DISABLE_ENDPOINT = 0x54,
    ACTION_BACKHAUL_MLD_UPDATE_REQUEST = 0x55,
    ACTION_BACKHAUL_TOPOLOGY_NOTIFICATION_COMMAND = 0x56,
    ACTION_BACKHAUL_WIRED_ONBOARDING_FAILED = 0x57,
    ACTION_BACKHAUL_WIRED_CONTROLLER_DETECTED = 0x58,
    ACTION_BACKHAUL_AFC_UPDATE_NOTIFICATION = 0x59,
    ACTION_BACKHAUL_ENUM_END = 0x5a,
};
...
enum eActionOp_APMANAGER: uint8_t {
    ...
    ACTION_APMANAGER_PLATFORM_ACS = 0xb,
    ...
    ACTION_APMANAGER_WDS_IFACE_NOTIFICATION = 0x26,
    ...
    ACTION_APMANAGER_RADIO_ENABLE_REQUEST = 0x3c,
    ACTION_APMANAGER_RADIO_MODE_CONFIG_REQUEST = 0x3d,
    ...
    ACTION_APMANAGER_MULTI_CHAN_BEACON_11K_REQUEST = 0x4c,
    ACTION_APMANAGER_MLD_UPDATE_REQUEST = 0x4d,
    ACTION_APMANAGER_MLD_MODE_UPDATE_REQUEST = 0x4e,
    ACTION_APMANAGER_QOS_MANAGEMENT_DESCRIPTOR_REQUEST = 0x4f,
    ACTION_APMANAGER_QOS_MANAGEMENT_POLICY_REQUEST = 0x50,
    ACTION_APMANAGER_BSS_SET_QOS_MANAGEMENT_REQUEST = 0x51,
    ACTION_APMANAGER_AFFILIATED_LINK_CHANGED_NOTIFICATION = 0x52,
    ACTION_APMANAGER_BSS_TEARDOWN_RESPONSE = 0x53,
    ACTION_APMANAGER_AFC_UPDATE_NOTIFICATION = 0x54,
    ACTION_APMANAGER_ENUM_END = 0x55,
};
...
enum eActionOp_MONITOR: uint8_t {
    ...
    ACTION_MONITOR_BYTE_COUNTER_UNITS_UPDATE_NOTIFICATION = 0x5,
