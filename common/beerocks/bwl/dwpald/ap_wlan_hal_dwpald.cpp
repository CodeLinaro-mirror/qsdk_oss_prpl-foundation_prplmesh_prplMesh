...
bool ap_wlan_hal_dwpal::start_platform_acs(
...
bool ap_wlan_hal_dwpal::change_radio_mode_config(
...
bool ap_wlan_hal_dwpal::get_afc_spectrum_update_data(sAfcSpectrumUpdateData &data)
{
    (void)data;
    LOG(TRACE) << __func__ << " - NOT IMPLEMENTED!";
    return false;
