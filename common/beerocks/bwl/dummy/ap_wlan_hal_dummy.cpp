...
bool ap_wlan_hal_dummy::process_dummy_event(parsed_obj_map_t &parsed_obj)
{
    ...
    case Event::AP_Sta_Possible_Psk_Mismatch: {
        ...
        LOG(DEBUG) << "STA connection failure: offending Sta MAC: " << sta_conn_fail->sta_mac;
        LOG(DEBUG) << "STA connection failure: interface BSSID: " << sta_conn_fail->bssid;
        ...
        LOG(DEBUG) << "STA connection failure: reason: " << sta_conn_fail->reason;
