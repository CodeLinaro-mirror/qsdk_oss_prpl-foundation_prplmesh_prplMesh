...
bool ap_wlan_hal_dummy::update_mld_mode(std::string ssid, uint8_t mld_mode)
{
    LOG(TRACE) << __func__ << " - NOT IMPLEMENTED!";
    return false;
}

bool ap_wlan_hal_dummy::update_mld_unit(std::string ssid_alias, int8_t mld_unit, bool reconfigure)
{
    LOG(TRACE) << __func__ << " - NOT IMPLEMENTED!";
    return false;
}
