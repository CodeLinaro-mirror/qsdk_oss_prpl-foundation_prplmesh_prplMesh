...
void base_wlan_hal_whm::update_eht_operations()
{
    ...
    auto &eht_ops        = m_radio_info.eht_operations;
    ...
    if (eht_ops_result.read_child(disabled_subchannel_bitmap_present,
        ...
        eht_ops.operation_parameters.disabled_subchannel_valid = disabled_subchannel_bitmap_present;
    }
