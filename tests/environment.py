...
class ChannelTlvs(Enum):
    ...
    CHANNEL_36 = (
        "0x10 "  # 16 operating classes
        "{0x73 0x03 {0x28 0x2C 0x30} 0x00} "  # opClass 0x73-115/3Chans:40,44,48/Pref 0
        "{0x74 0x01 {0x2C} 0x00} "
        "{0x75 {0x00 0x00}} "
        "{0x76 {0x00 0x00}} "
        "{0x77 {0x00 0x00}} "
    ...
    CHANNEL_36_160 = (
        "0x13 "  # 19 operating classes
        "{0x73 0x03 {0x28 0x2c 0x30} 0x10} "  # opClass 0x73-115/3Chans:40,44,48/Pref 0
        "{0x74 0x02 {0x24 0x2c} 0x10} "  # opClass 0x77-116Chans:40,44,48/Pref 0
        "{0x75 0x02 {0x28 0x30} 0x10} "
        "{0x76 0x04 {0x34 0x38 0x3c 0x40} 0x10} "
        "{0x77 0x02 {0x34 0x3c} 0x10} "
        "{0x78 0x02 {0x38 0x40} 0x10} "
        "{0x79 0x0c {0x64 0x68 0x6c 0x70 0x74 0x78 0x7c 0x80 0x84 0x88 0x8c 0x90} 0x10} "
        "{0x7a 0x06 {0x64 0x6c 0x74 0x7c 0x84 0x8c} 0x10} "
        "{0x7b 0x06 {0x68 0x70 0x78 0x80 0x88 0x90} 0x10} "
        "{0x7c 0x04 {0x95 0x99 0x9d 0xa1} 0x10} "
        "{0x7d 0x03 {0xa9 0xad 0xb1} 0x00} "
        "{0x7d 0x05 {0x95 0x99 0x9d 0xa1 0xa5} 0x10} "
        "{0x7e 0x01 {0xad} 0x00} "
        "{0x7e 0x03 {0x95 0x9d 0xa5} 0x10} "
        "{0x7f 0x02 {0xa9 0xb1} 0x00} "
        "{0x7f 0x02 {0x99 0xa1} 0x10} "
        "{0x80 0x07 {0x2a 0x3a 0x6a 0x7a 0x8a 0x9b 0xab} 0x10} "
        "{0x81 0x02 {0x72 0xa3} 0x10} "
        "{0x82 0x07 {0x2a 0x3a 0x6a 0x7a 0x8a 0x9b 0xab} 0x00}"
    )
    ...
    def __init__(self, name: str, device: None = None, is_controller: bool = False,
        ...
        if on_wsl or compose:
            published_port_output = subprocess.check_output(
                ["docker", "port", name, ucc_port]).decode('utf-8').partition('\n')[0].split(":")
