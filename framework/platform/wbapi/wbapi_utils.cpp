...
std::string wbapi_utils::bandwidth_to_string(const beerocks::eWiFiBandwidth &bandwidth)
{
...
const std::map<std::string, std::vector<WSC::eWscAuth>> wbapi_utils::security_mode_table = {
    ...
    {"WPA2-WPA3-Personal",
     {WSC::eWscAuth(WSC::eWscAuth::WSC_AUTH_WPA2PSK | WSC::eWscAuth::WSC_AUTH_SAE_AKM24)}},
    {"WPA3-Personal", {WSC::eWscAuth::WSC_AUTH_SAE}},
    {"WPA3-Personal", {WSC::eWscAuth::WSC_AUTH_SAE_AKM24}},
