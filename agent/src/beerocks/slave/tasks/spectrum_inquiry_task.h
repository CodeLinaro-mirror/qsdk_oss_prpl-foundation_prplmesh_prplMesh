...
private:
     ...
     *
     * Stores AFC inquiry payloads and per-radio platform data forwarded by ap_manager, builds
     * optional inquiry Channel Preference state (reason 0xD), then sends
     * AVAILABLE_SPECTRUM_INQUIRY_MESSAGE (§8.2.5).
     *
