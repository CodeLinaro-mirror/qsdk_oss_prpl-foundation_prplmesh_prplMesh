...
public:
     ...
     *
     * Supported events trigger either a full rebuild or an immediate exact WDS update.
     */
    ...
    enum eEvent : uint8_t {
        ...
        TS_NEW_WDS_IFACE   = 1, /**< Incrementally add one exact WDS iface. */
        TS_CLEAR_WDS_IFACE = 2, /**< Incrementally clear one exact WDS iface. */
