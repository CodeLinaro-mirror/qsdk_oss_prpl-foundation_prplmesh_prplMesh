...
private:
    ...
    */
    ...
    bool handle_rsn_parameters_configuration_tlv(ieee1905_1::CmduMessageRx &cmdu_rx,
                                                 std::vector<sBssInfo> &infos, const sMacAddr &ruid,
    ...
    bool send_bsta_configuration(const sMacAddr &radio_mac, const sBStaInfo &info);

    bool send_enable_disable_endpoint(const sMacAddr &radio_mac, const bool enable);

    bool validate_reconfiguration(const std::string &radio_iface, std::vector<sBssInfo> &infos);
