...
Generated on 2026-06-25 11:07



## [6.0.1](https://gitlab.com/prpl-foundation/prplmesh/prplMesh/-/releases/6.0.1) - 2026-06-25 11:07:08 +0200


### Changed

- [common: optimize base\_wlan\_hal\_whm::refresh\_radio\_info\(\)](https://prplfoundationcloud.atlassian.net/browse/PPM-4077)
- [conn\_map: summarize agent classifications](https://prplfoundationcloud.atlassian.net/browse/PPM-4001)

### Fixed

- [ci: remove wireless credential before starting test](https://prplfoundationcloud.atlassian.net/browse/PPM-4118)
- [ci: install lzop and libbsd-dev in builder image](https://prplfoundationcloud.atlassian.net/browse/PPM-4130)
- [fronthual: fix csa\_notification\_timer fd leakage](https://prplfoundationcloud.atlassian.net/browse/PPM-4129)
- [Boardfarm: fix importerror for module pytz](https://prplfoundationcloud.atlassian.net/browse/)
- [agent: fix invalid STA in unassoc link metrics resp](https://prplfoundationcloud.atlassian.net/browse/PPM-4111)
- [controller: use AL-MAC for prplMesh classification](https://prplfoundationcloud.atlassian.net/browse/PPM-4034)
- [agent: reapply TS VLAN changes](https://prplfoundationcloud.atlassian.net/browse/PPM-4083)
- [tlvf: accept variable-length WSC public keys](https://prplfoundationcloud.atlassian.net/browse/PPM-4108)


## [6.0.0](https://gitlab.com/prpl-foundation/prplmesh/prplMesh/-/releases/6.0.0) - 2026-06-04 09:38:28 +0200


### Changed

- [Fix for bSTA MLD Info empty during R6 certification](https://prplfoundationcloud.atlassian.net/browse/PPM-4091)
- [bwl: whm: bSTAMLD API implementation](https://prplfoundationcloud.atlassian.net/browse/PPM-3987)
- [Add MLO Affiliated STA Link Change Detection](https://prplfoundationcloud.atlassian.net/browse/PPM-3648)
- [controller: SCS/MSCS, descriptors, and settings](https://prplfoundationcloud.atlassian.net/browse/PPM-4003)
- [controller: fallback to non-prplMesh onboarding on VS TLV mismatch](https://prplfoundationcloud.atlassian.net/browse/PPM-3993)
- [traffic\_separation: handle wds and fh ifaces events](https://prplfoundationcloud.atlassian.net/browse/PPM-3905)
- [prplmesh\_cli: conn\_map refactoring](https://prplfoundationcloud.atlassian.net/browse/PPM-3988)
- [agent: MSCS/SCS: QOS\_MANAGEMENT\_NOTIFICATION\_MESSAGE and radio capabilities](https://prplfoundationcloud.atlassian.net/browse/PPM-3128)
- [CI: add CRAM tests](https://prplfoundationcloud.atlassian.net/browse/PPM-3976)
- [multi-vendor: add vendor-specific TLV parsing on receive path](https://prplfoundationcloud.atlassian.net/browse/PPM-3833)
- [\[Controller\]\[R6\] Handle bSTA MLD Configuration Response Message](https://prplfoundationcloud.atlassian.net/browse/PPM-3227)
- [boardfarm: add StaticPuncturing test](https://prplfoundationcloud.atlassian.net/browse/PPM_3909)
- [common: framwork: optimize repeating calls of get\_param](https://prplfoundationcloud.atlassian.net/browse/PPM-3935)
- [added support for BWL update\_mld\_mode](https://prplfoundationcloud.atlassian.net/browse/PPM-3820)
- [controller: handle associated clients tlv](https://prplfoundationcloud.atlassian.net/browse/PPM-3771)
- [Eliminate shared agent parameters and align configuration handling](https://prplfoundationcloud.atlassian.net/browse/PPM-3916)
- [controller: Send BSSAdvancedConfiguration TLV](https://prplfoundationcloud.atlassian.net/browse/PPM-3902)
- [agent: Receive BSSAdvancedConfiguration TLV](https://prplfoundationcloud.atlassian.net/browse/PPM-3903)
...
- [agent: enhance tc qos filter handling](https://prplfoundationcloud.atlassian.net/browse/PPM-4019)
- [easylogging: trigger exit instead of abort when FATAL arrives](https://prplfoundationcloud.atlassian.net/browse/PPM-4030)
- [agent: add reconfigure flag to ap mld update request](https://prplfoundationcloud.atlassian.net/browse/PPM-3772)
- [agent: common: fix issues reported by coverity](https://prplfoundationcloud.atlassian.net/browse/PPM-3912)
- [bcl: son\_wireless\_utils: avoid copying channels tables on every call](https://prplfoundationcloud.atlassian.net/browse/PPM-4062)
- [agent:  add ap mld mac in disassoc event](https://prplfoundationcloud.atlassian.net/browse/PPM-4064)
- [agent: common: controller: vendor\_message: fix coverity issues](https://prplfoundationcloud.atlassian.net/browse/PPM-3917)
- [agent: remove duplicate link metrics reporting](https://prplfoundationcloud.atlassian.net/browse/PPM-3567)
- [agent: don't abort Link Metric Response on partial failures](https://prplfoundationcloud.atlassian.net/browse/PPM-4028)
- [agent: separate BSS active from enabled state](https://prplfoundationcloud.atlassian.net/browse/PPM-4035)
- [Removal of X-PRPL\_ORG\_ in prplMesh DMs](https://prplfoundationcloud.atlassian.net/browse/PPM-3488)
- [agent: channel\_scan\_task: send report for all scan states](https://prplfoundationcloud.atlassian.net/browse/PPM-3794)
- [agent: LinkMetricsCollectionTask: Change measurement duration to cover MLD bSTA](https://prplfoundationcloud.atlassian.net/browse/PPM-4006)
- [db: fix settings\_client\_optimal\_path\_roaming\_prefer\_signal\_strength behavior](https://prplfoundationcloud.atlassian.net/browse/PPM-4007)
- [agent: common: fix link metric response data collecting](https://prplfoundationcloud.atlassian.net/browse/PPM-3769)
- [bwl: harden WHM last assoc frame handling](https://prplfoundationcloud.atlassian.net/browse/PPM-3995)
- [ap\_manager: Clear blacklist only in certification\_mode](https://prplfoundationcloud.atlassian.net/browse/PPM-3957)
- [agent: handle JOIN\_RESP\_REJECT and ignore early credentials response](https://prplfoundationcloud.atlassian.net/browse/PPM-3984)
- [transport: stop tagging 1905 multicast in raw tx](https://prplfoundationcloud.atlassian.net/browse/PPM-3983)
- [btl: drop CMDUs with empty MACs](https://prplfoundationcloud.atlassian.net/browse/PPM-3979)
- [prplMesh :Agent: Operating Channel Preference Report Contains extra channels](https://prplfoundationcloud.atlassian.net/browse/PPW-551)
- [agent: controller: common: framework: fix ssid advertisement](https://prplfoundationcloud.atlassian.net/browse/PPM-3977)
- [tlvf: fix sVendorOUI::struct\_swap\(\) corrupting OUI bytes](https://prplfoundationcloud.atlassian.net/browse/PPM-3818)
- [bwl, controller: fix failed-connection events and stale radio updates](https://prplfoundationcloud.atlassian.net/browse/PPM-3939)
