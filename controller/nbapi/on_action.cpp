 ...
 */
static bool send_ap_config_renew()
{
...
{
    std::vector<beerocks::nbapi::sEvents> events_list = {
    ...
    auto tmpl = get_templates_events_list();
    events_list.insert(events_list.end(), tmpl.begin(), tmpl.end());
    return events_list;
}
