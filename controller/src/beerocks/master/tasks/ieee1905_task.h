...
protected:
    ...
    struct AL {
        ...
        SingleShotCounter info_pending; ///< To track initial AL information collection.
        SingleShotCounter topology_response_pending; ///< To track the first Topology Response.
