...
public:
    ...
    void set_operating_class(uint8_t operating_class) { m_operating_class = operating_class; };
    void set_channel(uint8_t channel_in) { m_channel = channel_in; };
    uint8_t get_operating_class() const { return m_operating_class; };
