...
private:
    ...
    bool handle_cmdu_1905_1_message(uint32_t iface_index, const sMacAddr &src_mac,
                                    ieee1905_1::CmduMessageRx &cmdu_rx);
    ...
    bool handle_cmdu_1905_autoconfiguration_search(uint32_t iface_index, const sMacAddr &src_mac,
                                                   ieee1905_1::CmduMessageRx &cmdu_rx);
    ...
    bool
    handle_cmdu_1905_bsta_mld_configuration_response_message(const sMacAddr &src_mac,
                                                             ieee1905_1::CmduMessageRx &cmdu_rx);
    ...
    */
    ...
    bool handle_cmdu_1905_dpp_bootstrapping_uri_notification(const sMacAddr &src_mac,
                                                             ieee1905_1::CmduMessageRx &cmdu_rx);
};
