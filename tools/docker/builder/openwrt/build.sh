...
main() {
    ...
    if [[ " ${legacy_platforms[*]} " =~ " $TARGET_DEVICE " ]] ; then
        ...
        dbg "$TARGET_DEVICE non-legacy platform, building on prplOS latest-24.10_2026-07-24"
        OPENWRT_TOOLCHAIN_VERSION='8aa203a46f5860677711934ff985727447c4af42'
        OPENWRT_VERSION='8aa203a46f5860677711934ff985727447c4af42'
    fi
...
# prplos latest-24.10_2026-07-24
OPENWRT_TOOLCHAIN_VERSION='8aa203a46f5860677711934ff985727447c4af42'
OPENWRT_VERSION='8aa203a46f5860677711934ff985727447c4af42'
