...
main() {
    ...
    if [[ " ${legacy_platforms[*]} " =~ " $TARGET_DEVICE " ]] ; then
        ...
        dbg "$TARGET_DEVICE non-legacy platform, building on prplOS latest-24.10_2026-06-22-feed-MTK test"
        OPENWRT_TOOLCHAIN_VERSION='75a2b11c1be08b18d62214a8d21f9fc9ee85f0ca'
        OPENWRT_VERSION='75a2b11c1be08b18d62214a8d21f9fc9ee85f0ca'
    fi
...
# prplos latest-24.10_2026-06-08
OPENWRT_TOOLCHAIN_VERSION='75a2b11c1be08b18d62214a8d21f9fc9ee85f0ca'
OPENWRT_VERSION='75a2b11c1be08b18d62214a8d21f9fc9ee85f0ca'
