...
main() {
    ...
    if [[ " ${legacy_platforms[*]} " =~ " $TARGET_DEVICE " ]] ; then
        ...
        dbg "$TARGET_DEVICE non-legacy platform, building on prplOS latest-24.10_2025-11-27 - libamxb downstep + pwhm managed daemon args + ATH13.1"
        OPENWRT_TOOLCHAIN_VERSION='9eeee4e28edf32e21e6130aad8a4706d0d41708e'
        OPENWRT_VERSION='9eeee4e28edf32e21e6130aad8a4706d0d41708e'
    fi
