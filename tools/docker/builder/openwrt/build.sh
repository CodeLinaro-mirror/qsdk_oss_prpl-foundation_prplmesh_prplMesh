...
main() {
    ...
    if [[ " ${legacy_platforms[*]} " =~ " $TARGET_DEVICE " ]] ; then
        ...
        dbg "$TARGET_DEVICE non-legacy platform, building on prplos mainline-23.05, 9 sept 2025"
        OPENWRT_TOOLCHAIN_VERSION='8e719746966c39bd8db590cce44161712b638fe4'
        OPENWRT_VERSION='8e719746966c39bd8db590cce44161712b638fe4'
    fi
