...
main() {
    ...
    if [[ " ${legacy_platforms[*]} " =~ " $TARGET_DEVICE " ]] ; then
        ...
        dbg "$TARGET_DEVICE non-legacy platform, building on prplOS latest-24.10_2025-08-28"
        OPENWRT_TOOLCHAIN_VERSION='c5ccf31d7869e4a6c49a513f5dc698af78d83deb'
        OPENWRT_VERSION='c5ccf31d7869e4a6c49a513f5dc698af78d83deb'
    fi
