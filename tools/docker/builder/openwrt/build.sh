...
main() {
    ...
    if [[ " ${legacy_platforms[*]} " =~ " $TARGET_DEVICE " ]] ; then
        ...
        dbg "$TARGET_DEVICE non-legacy platform, building on prplOS latest-24.10_2025-09-06"
        OPENWRT_TOOLCHAIN_VERSION='bc617b6454305b5b0392547eaafa3fcd8996dc13'
        OPENWRT_VERSION='bc617b6454305b5b0392547eaafa3fcd8996dc13'
    fi
...
# prplos latest-24.10_2025-09-06
OPENWRT_TOOLCHAIN_VERSION='bc617b6454305b5b0392547eaafa3fcd8996dc13'
OPENWRT_VERSION='bc617b6454305b5b0392547eaafa3fcd8996dc13'
