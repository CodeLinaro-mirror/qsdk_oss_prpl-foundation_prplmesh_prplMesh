...
main() {
    ...
    if [[ " ${legacy_platforms[*]} " =~ " $TARGET_DEVICE " ]] ; then
        ...
        dbg "$TARGET_DEVICE non-legacy platform, building on prplOS latest-24.10_2025-10-06 UPDK-9.2.0"
        OPENWRT_TOOLCHAIN_VERSION='e9ea79098aeb8595771e36d1efcc61a252f45a44'
        OPENWRT_VERSION='e9ea79098aeb8595771e36d1efcc61a252f45a44'
    fi
...
# prplos latest-24.10_2025-10-06
OPENWRT_TOOLCHAIN_VERSION='e9ea79098aeb8595771e36d1efcc61a252f45a44'
OPENWRT_VERSION='e9ea79098aeb8595771e36d1efcc61a252f45a44'
