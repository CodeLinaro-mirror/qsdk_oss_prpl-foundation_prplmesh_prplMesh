...
main() {
    ...
    if [[ " ${legacy_platforms[*]} " =~ " $TARGET_DEVICE " ]] ; then
        ...
        dbg "$TARGET_DEVICE non-legacy platform, building on prplOS latest-24.10_2026-04-03"
        OPENWRT_TOOLCHAIN_VERSION='cd4c4f608a1b98b39046bcbca3b4aa0d13d17710'
        OPENWRT_VERSION='cd4c4f608a1b98b39046bcbca3b4aa0d13d17710'
    fi
...
# prplos latest-24.10_2026-04-03
OPENWRT_TOOLCHAIN_VERSION='cd4c4f608a1b98b39046bcbca3b4aa0d13d17710'
OPENWRT_VERSION='cd4c4f608a1b98b39046bcbca3b4aa0d13d17710'
