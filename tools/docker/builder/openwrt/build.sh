...
main() {
    ...
    if [[ " ${legacy_platforms[*]} " =~ " $TARGET_DEVICE " ]] ; then
        ...
        dbg "Haze platform, build on prplos mainline 3.1 + pWHM 6.26.1"
        OPENWRT_TOOLCHAIN_VERSION='174eeac50f7ffa7e09518d486dab9c0c9602e616'
        OPENWRT_VERSION='174eeac50f7ffa7e09518d486dab9c0c9602e616'
    elif [[ "urx_osp" == "$TARGET_DEVICE" ]] ; then
        dbg "OSP platform, build on prplos mainline 3.1 + UPDK 9.1.60.2 + pWHM 6.26.1"
        OPENWRT_TOOLCHAIN_VERSION='174eeac50f7ffa7e09518d486dab9c0c9602e616'
        OPENWRT_VERSION='174eeac50f7ffa7e09518d486dab9c0c9602e616'
    else
