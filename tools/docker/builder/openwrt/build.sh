...
main() {
    ...
    if [[ " ${legacy_platforms[*]} " =~ " $TARGET_DEVICE " ]] ; then
        ...
        dbg "$TARGET_DEVICE non-legacy platform, building on prplOS UPDK-9.2.10-ER"
        OPENWRT_TOOLCHAIN_VERSION='01f0e246ed389354316918e780ba4c5a9bf65d15'
        OPENWRT_VERSION='01f0e246ed389354316918e780ba4c5a9bf65d15'
    fi
