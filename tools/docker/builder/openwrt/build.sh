...
main() {
    ...
    if [[ " ${legacy_platforms[*]} " =~ " $TARGET_DEVICE " ]] ; then
        ...
        dbg "$TARGET_DEVICE non-legacy platform, building on prplOS mainline-23.05 + UPDK-9.1.90"
        OPENWRT_TOOLCHAIN_VERSION='0cf44e5a3ff68cbd18e95a38d14e728d996aa5fc'
        OPENWRT_VERSION='0cf44e5a3ff68cbd18e95a38d14e728d996aa5fc'
    fi
