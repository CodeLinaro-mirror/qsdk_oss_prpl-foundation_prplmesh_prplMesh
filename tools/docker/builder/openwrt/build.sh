...
main() {
    ...
    if [[ "haze" == "$TARGET_DEVICE" ]] ; then
        ...
        OPENWRT_TOOLCHAIN_VERSION='7bd8640a26a751b33c354a15517c5ce6f6a8d4b3'
        OPENWRT_VERSION='7bd8640a26a751b33c354a15517c5ce6f6a8d4b3'
        ...
        dbg "Freedom platform, prplOS mainline-3.2 + vlanid patch + new networklayout"
        OPENWRT_TOOLCHAIN_VERSION='7bd8640a26a751b33c354a15517c5ce6f6a8d4b3'
        OPENWRT_VERSION='7bd8640a26a751b33c354a15517c5ce6f6a8d4b3'
    else
