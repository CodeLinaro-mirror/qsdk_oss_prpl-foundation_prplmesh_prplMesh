...
main() {
    ...
    if [[ " ${legacy_platforms[*]} " =~ " $TARGET_DEVICE " ]] ; then
        ...
        dbg "$TARGET_DEVICE non-legacy platform, building on prplOS latest-24.10_2026-02-24 - ATH13.1 - assocrec issue"
        OPENWRT_TOOLCHAIN_VERSION='939bb173cc5e8eaac53ae5b8d731875e10137250'
        OPENWRT_VERSION='939bb173cc5e8eaac53ae5b8d731875e10137250'
    fi
