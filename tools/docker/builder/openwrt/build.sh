...
main() {
    ...
    if [[ " ${legacy_platforms[*]} " =~ " $TARGET_DEVICE " ]] ; then
        ...
        dbg "$TARGET_DEVICE non-legacy platform, building on prplOS latest-24.10_2025-08-05 (really 24.10)"
        OPENWRT_TOOLCHAIN_VERSION='743214c800df8d298b1524f97544993bd86de88b'
        OPENWRT_VERSION='743214c800df8d298b1524f97544993bd86de88b'
    fi
...
# prplos latest-24.10_2025-08-05
OPENWRT_TOOLCHAIN_VERSION='743214c800df8d298b1524f97544993bd86de88b'
OPENWRT_VERSION='743214c800df8d298b1524f97544993bd86de88b'
