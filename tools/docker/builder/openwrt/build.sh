...
main() {
    ...
    if [[ " ${legacy_platforms[*]} " =~ " $TARGET_DEVICE " ]] ; then
        ...
        dbg "$TARGET_DEVICE non-legacy platform, building on prplOS latest-24.10_2026-04-28 - QCA 6GHz ENDPOINT FIX"
        OPENWRT_TOOLCHAIN_VERSION='35632368f601608041400204a478e7731b9b7d83'
        OPENWRT_VERSION='35632368f601608041400204a478e7731b9b7d83'
    fi
...
# prplos latest-24.10_2026-04-10
OPENWRT_TOOLCHAIN_VERSION='35632368f601608041400204a478e7731b9b7d83'
OPENWRT_VERSION='35632368f601608041400204a478e7731b9b7d83'
