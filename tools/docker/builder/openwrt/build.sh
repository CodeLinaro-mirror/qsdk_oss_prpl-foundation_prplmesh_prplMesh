...
main() {
    ...
    if [[ "haze" == "$TARGET_DEVICE" ]] ; then
        ...
        dbg "OSP platform, prplOS mainline 3.2 + WHM stable"
        OPENWRT_TOOLCHAIN_VERSION='f350ad62d39371b2ec7a872f11556673d41af898'
        OPENWRT_VERSION='f350ad62d39371b2ec7a872f11556673d41af898'
