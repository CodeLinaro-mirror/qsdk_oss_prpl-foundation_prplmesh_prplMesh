...
main() {
    ...
    if [[ " ${legacy_platforms[*]} " =~ " $TARGET_DEVICE " ]] ; then
        ...
        dbg "$TARGET_DEVICE non-legacy platform, building on prplOS latest-24.10_2026-08-29"
        OPENWRT_TOOLCHAIN_VERSION='6753f152bc02f3ae2ced22c1f8c54ed823ded013'
        OPENWRT_VERSION='6753f152bc02f3ae2ced22c1f8c54ed823ded013'
    fi
...
# prplos latest-24.10_2026-08-29
OPENWRT_TOOLCHAIN_VERSION='6753f152bc02f3ae2ced22c1f8c54ed823ded013'
OPENWRT_VERSION='6753f152bc02f3ae2ced22c1f8c54ed823ded013'
