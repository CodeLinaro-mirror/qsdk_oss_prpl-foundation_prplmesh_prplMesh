...
main() {
    ...
    if [[ " ${legacy_platforms[*]} " =~ " $TARGET_DEVICE " ]] ; then
        ...
        dbg "$TARGET_DEVICE non-legacy platform, building on prplOS latest-24.10_2026-05-12"
        OPENWRT_TOOLCHAIN_VERSION='1c4cce964bb05036cfe630c577c68818e05a2c14'
        OPENWRT_VERSION='1c4cce964bb05036cfe630c577c68818e05a2c14'
    fi
