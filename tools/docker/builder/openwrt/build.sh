...
main() {
    ...
    if [[ " ${legacy_platforms[*]} " =~ " $TARGET_DEVICE " ]] ; then
        ...
        dbg "$TARGET_DEVICE non-legacy platform, building on prplOS latest-24.10_2026-06-06"
        OPENWRT_TOOLCHAIN_VERSION='f5f79d2828b6c14bd85334662bc67c0e43594ef9'
        OPENWRT_VERSION='f5f79d2828b6c14bd85334662bc67c0e43594ef9'
    fi
