...
main() {
    ...
    *)
    ...
    if [[ " ${legacy_platforms[*]} " =~ " $TARGET_DEVICE " ]]; then
        ...
        dbg "$TARGET_DEVICE non-legacy platform, building on prplOS latest-24.10_2025-07-07"
        OPENWRT_TOOLCHAIN_VERSION='5a3f28e6e9fbd7724b947aa45a209cae3ae2005a'
        OPENWRT_VERSION='5a3f28e6e9fbd7724b947aa45a209cae3ae2005a'
    fi
...
# prplos latest-24.10_2025-07-07
OPENWRT_TOOLCHAIN_VERSION='5a3f28e6e9fbd7724b947aa45a209cae3ae2005a'
OPENWRT_VERSION='5a3f28e6e9fbd7724b947aa45a209cae3ae2005a'
