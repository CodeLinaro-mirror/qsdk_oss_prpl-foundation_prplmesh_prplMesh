...
main() {
    ...
    if [[ " ${legacy_platforms[*]} " =~ " $TARGET_DEVICE " ]] ; then
        ...
        dbg "$TARGET_DEVICE non-legacy platform, building on prplOS UPDK-9.2.10-ED"
        OPENWRT_TOOLCHAIN_VERSION='436db5fd76ab58644597fa7978784b39874f3a21'
        OPENWRT_VERSION='436db5fd76ab58644597fa7978784b39874f3a21'
    fi
...
# prplos UPDK-9.2.10-ED
OPENWRT_TOOLCHAIN_VERSION='b431a3e638eba80c26ed68769fb01ebd2e1c6e89'
OPENWRT_VERSION='b431a3e638eba80c26ed68769fb01ebd2e1c6e89'
