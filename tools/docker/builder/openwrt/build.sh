...
main() {
    ...
    if [[ " ${legacy_platforms[*]} " =~ " $TARGET_DEVICE " ]] ; then
        ...
        dbg "$TARGET_DEVICE non-legacy platform, building on prplOS dev_PPW-2025_1_latest-24.10"
        OPENWRT_TOOLCHAIN_VERSION='2bff6519a799967a2ff65c060374c17c060b7b81'
        OPENWRT_VERSION='2bff6519a799967a2ff65c060374c17c060b7b81'
    fi
...
# prplos dev_PPW-2025_1_latest-24.10
OPENWRT_TOOLCHAIN_VERSION='2bff6519a799967a2ff65c060374c17c060b7b81'
OPENWRT_VERSION='2bff6519a799967a2ff65c060374c17c060b7b81'
