...
main() {
    ...
    if [[ " ${legacy_platforms[*]} " =~ " $TARGET_DEVICE " ]] ; then
        ...
        dbg "$TARGET_DEVICE non-legacy platform, building on prplOS latest-24.10 mr 3097 + debug patch"
        OPENWRT_TOOLCHAIN_VERSION='eae8e4d54db588634c2d0155fefbd2bcc0b7dd4a'
        OPENWRT_VERSION='eae8e4d54db588634c2d0155fefbd2bcc0b7dd4a'
    fi
...
# prplos latest-24.10 mr 3097 + debug patch
OPENWRT_TOOLCHAIN_VERSION='eae8e4d54db588634c2d0155fefbd2bcc0b7dd4a'
OPENWRT_VERSION='eae8e4d54db588634c2d0155fefbd2bcc0b7dd4a'
