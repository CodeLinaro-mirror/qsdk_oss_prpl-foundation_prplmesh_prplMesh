...
main() {
    ...
    if [[ " ${legacy_platforms[*]} " =~ " $TARGET_DEVICE " ]] ; then
        ...
        dbg "$TARGET_DEVICE non-legacy platform, building on prplOS mr 2686"
        OPENWRT_TOOLCHAIN_VERSION='6318d8ee1d42a5cc94f720650c4bb463e0cb4c6f'
        OPENWRT_VERSION='6318d8ee1d42a5cc94f720650c4bb463e0cb4c6f'
    fi
