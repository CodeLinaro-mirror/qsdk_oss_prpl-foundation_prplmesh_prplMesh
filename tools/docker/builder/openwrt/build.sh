...
main() {
    ...
    if [[ " ${legacy_platforms[*]} " =~ " $TARGET_DEVICE " ]] ; then
        ...
        dbg "$TARGET_DEVICE non-legacy platform, building on prplOS latest-24.10_2026-08-28"
        OPENWRT_TOOLCHAIN_VERSION='50317acfc7f913dba701559000a086a8872a9cd7'
        OPENWRT_VERSION='50317acfc7f913dba701559000a086a8872a9cd7'
    fi
...
# prplos latest-24.10_2026-08-28
OPENWRT_TOOLCHAIN_VERSION='50317acfc7f913dba701559000a086a8872a9cd7'
OPENWRT_VERSION='50317acfc7f913dba701559000a086a8872a9cd7'
