...
main() {
    ...
    if [[ " ${legacy_platforms[*]} " =~ " $TARGET_DEVICE " ]] ; then
        ...
        dbg "$TARGET_DEVICE non-legacy platform, building on prplOS latest-24.10_2026-03-09"
        OPENWRT_TOOLCHAIN_VERSION='3c2ef152fe00ad0305b39a233583b432c3254785'
        OPENWRT_VERSION='3c2ef152fe00ad0305b39a233583b432c3254785'
    fi
...
# prplos latest-24.10_2026-03-09
OPENWRT_TOOLCHAIN_VERSION='3c2ef152fe00ad0305b39a233583b432c3254785'
OPENWRT_VERSION='3c2ef152fe00ad0305b39a233583b432c3254785'
