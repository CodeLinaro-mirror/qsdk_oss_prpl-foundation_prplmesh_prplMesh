...
main() {
    ...
    if [[ " ${legacy_platforms[*]} " =~ " $TARGET_DEVICE " ]] ; then
        ...
        dbg "$TARGET_DEVICE non-legacy platform, building on prplOS latest-24.10_2025-10-10"
        OPENWRT_TOOLCHAIN_VERSION='f6a0442b3f4306e987d55a612917c75501ac45ad'
        OPENWRT_VERSION='f6a0442b3f4306e987d55a612917c75501ac45ad'
    fi
...
# prplos latest-24.10_2025-10-10
OPENWRT_TOOLCHAIN_VERSION='f6a0442b3f4306e987d55a612917c75501ac45ad'
OPENWRT_VERSION='f6a0442b3f4306e987d55a612917c75501ac45ad'
