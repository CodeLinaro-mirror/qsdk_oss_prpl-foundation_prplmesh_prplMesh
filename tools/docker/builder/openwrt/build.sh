...
main() {
    ...
    if [[ " ${legacy_platforms[*]} " =~ " $TARGET_DEVICE " ]] ; then
        ...
        dbg "$TARGET_DEVICE non-legacy platform, building on prplOS latest-24.10_2025-08-29"
        OPENWRT_TOOLCHAIN_VERSION='a259ba1420ab3c3d0dd8cd2c38ab90ccbd229e29'
        OPENWRT_VERSION='a259ba1420ab3c3d0dd8cd2c38ab90ccbd229e29'
    fi
