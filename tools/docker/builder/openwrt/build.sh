...
main() {
    ...
    if [[ " ${legacy_platforms[*]} " =~ " $TARGET_DEVICE " ]] ; then
        ...
        dbg "$TARGET_DEVICE non-legacy platform, building on prplOS mr 2453"
        OPENWRT_TOOLCHAIN_VERSION='3139f73c54fb682d8281654c2dbada62d7fe7856'
        OPENWRT_VERSION='3139f73c54fb682d8281654c2dbada62d7fe7856'
    fi
