...
main() {
    ...
    if [[ " ${legacy_platforms[*]} " =~ " $TARGET_DEVICE " ]] ; then
        ...
        dbg "$TARGET_DEVICE non-legacy platform, building on prplOS latest-24.10_2026-02-24 - ATH13.1"
        OPENWRT_TOOLCHAIN_VERSION='92c6396aff053cb613717ea464a2d4e1ee624d85'
        OPENWRT_VERSION='92c6396aff053cb613717ea464a2d4e1ee624d85'
    fi
