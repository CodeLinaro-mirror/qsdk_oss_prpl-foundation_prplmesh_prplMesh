...
main() {
    ...
    if [[ "haze" == "$TARGET_DEVICE" ]] ; then
        ...
        dbg "Freedom platform, prplOS mainline + added VAPs"
        OPENWRT_TOOLCHAIN_VERSION='42628d8170f872830da7cd7a1d7ae85d66fca2a5'
        OPENWRT_VERSION='42628d8170f872830da7cd7a1d7ae85d66fca2a5'
    else
