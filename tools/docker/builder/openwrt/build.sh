...
main() {
    ...
    if [[ "haze" == "$TARGET_DEVICE" ]] ; then
        ...
        OPENWRT_TOOLCHAIN_VERSION='2615d1d0448051eb4a21dab648acb3d5c53f633a'
        OPENWRT_VERSION='2615d1d0448051eb4a21dab648acb3d5c53f633a'
        ...
        dbg "Freedom platform, prplOS mainline-3.2 + vlanid patch + whm 6.44.16"
        OPENWRT_TOOLCHAIN_VERSION='2615d1d0448051eb4a21dab648acb3d5c53f633a'
        OPENWRT_VERSION='2615d1d0448051eb4a21dab648acb3d5c53f633a'
    else
