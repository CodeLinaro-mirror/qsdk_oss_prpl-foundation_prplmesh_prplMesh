...
main() {
    ...
    if [[ " ${legacy_platforms[*]} " =~ " $TARGET_DEVICE " ]] ; then
        ...
        dbg "$TARGET_DEVICE non-legacy platform, building on prplOS latest-24.10_2026-02-24 - ATH13.1+WPS fix"
        OPENWRT_TOOLCHAIN_VERSION='348f22bca965f18f3645e752d22e39a6e278cc40'
        OPENWRT_VERSION='348f22bca965f18f3645e752d22e39a6e278cc40'
    fi
