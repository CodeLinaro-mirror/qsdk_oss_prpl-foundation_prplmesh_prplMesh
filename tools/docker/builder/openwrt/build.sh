...
main() {
    ...
    if [[ " ${legacy_platforms[*]} " =~ " $TARGET_DEVICE " ]] ; then
        ...
        dbg "$TARGET_DEVICE non-legacy platform, building on prplOS mainline-23.05 (stable-v4.0)"
        OPENWRT_TOOLCHAIN_VERSION='7cebafd90f2e771fef8b9d2b32c64dfbf1112676'
        OPENWRT_VERSION='7cebafd90f2e771fef8b9d2b32c64dfbf1112676'
    fi
