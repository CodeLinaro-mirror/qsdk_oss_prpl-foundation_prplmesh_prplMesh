...
main() {
    ...
    if [[ " ${legacy_platforms[*]} " =~ " $TARGET_DEVICE " ]] ; then
        ...
        dbg "$TARGET_DEVICE non-legacy platform, building on prplOS dev_PPM-1912_latest-24.10 2026-06-09"
        OPENWRT_TOOLCHAIN_VERSION='5d244a2abe10b6d5e42389977b3208907d3555a8'
        OPENWRT_VERSION='5d244a2abe10b6d5e42389977b3208907d3555a8'
    fi
...
# prplos dev_PPM-1912_latest-24.10 2026-06-09
OPENWRT_TOOLCHAIN_VERSION='5d244a2abe10b6d5e42389977b3208907d3555a8'
OPENWRT_VERSION='5d244a2abe10b6d5e42389977b3208907d3555a8'
