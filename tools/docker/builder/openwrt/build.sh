...
main() {
    ...
    if [[ " ${legacy_platforms[*]} " =~ " $TARGET_DEVICE " ]] ; then
        ...
        dbg "$TARGET_DEVICE non-legacy platform, building on prplOS latest-24.10_2026-05-29"
        OPENWRT_TOOLCHAIN_VERSION='0b5b78225d9dc30f8f42252b15288509bea63ca4'
        OPENWRT_VERSION='0b5b78225d9dc30f8f42252b15288509bea63ca4'
    fi
...
# prplos latest-24.10_2026-05-29
OPENWRT_TOOLCHAIN_VERSION='0b5b78225d9dc30f8f42252b15288509bea63ca4'
OPENWRT_VERSION='0b5b78225d9dc30f8f42252b15288509bea63ca4'
