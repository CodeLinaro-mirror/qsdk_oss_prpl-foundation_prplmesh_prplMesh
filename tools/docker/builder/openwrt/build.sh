...
main() {
    ...
    if [[ " ${legacy_platforms[*]} " =~ " $TARGET_DEVICE " ]] ; then
        ...
        dbg "$TARGET_DEVICE non-legacy platform, building on prplOS latest-24.10_2026-02-20-ath13.1"
        OPENWRT_TOOLCHAIN_VERSION='da27f4b601d8680a9bdff814cf4709ee64f618b0'
        OPENWRT_VERSION='da27f4b601d8680a9bdff814cf4709ee64f618b0'
    fi
...
# prplos latest-24.10_2026-02-20-ath13.1
OPENWRT_TOOLCHAIN_VERSION='da27f4b601d8680a9bdff814cf4709ee64f618b0'
OPENWRT_VERSION='da27f4b601d8680a9bdff814cf4709ee64f618b0'
