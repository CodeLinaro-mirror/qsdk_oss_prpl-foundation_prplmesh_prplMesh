...
main() {
    ...
    if [[ " ${legacy_platforms[*]} " =~ " $TARGET_DEVICE " ]] ; then
        ...
        dbg "$TARGET_DEVICE non-legacy platform, building on prplOS dev_PPW-698_latest-24.10"
        OPENWRT_TOOLCHAIN_VERSION='4fe01fdd7c77d8703f58cb5b2c018893b0427e01'
        OPENWRT_VERSION='4fe01fdd7c77d8703f58cb5b2c018893b0427e01'
    fi
