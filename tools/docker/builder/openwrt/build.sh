...
main() {
    ...
    if [[ " ${legacy_platforms[*]} " =~ " $TARGET_DEVICE " ]] ; then
        ...
        dbg "$TARGET_DEVICE non-legacy platform, building on prplOS latest-24.10_2026-02-26"
        OPENWRT_TOOLCHAIN_VERSION='347f5209b1e76f67392f6b688d4ca3a9b9461fa4'
        OPENWRT_VERSION='347f5209b1e76f67392f6b688d4ca3a9b9461fa4'
    fi
...
# prplos latest-24.10_2026-02-26
OPENWRT_TOOLCHAIN_VERSION='347f5209b1e76f67392f6b688d4ca3a9b9461fa4'
OPENWRT_VERSION='347f5209b1e76f67392f6b688d4ca3a9b9461fa4'
