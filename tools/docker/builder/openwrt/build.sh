...
main() {
    ...
    if [[ " ${legacy_platforms[*]} " =~ " $TARGET_DEVICE " ]] ; then
        ...
        dbg "$TARGET_DEVICE non-legacy platform, building on prplOS latest-24.10_2025-10-20"
        OPENWRT_TOOLCHAIN_VERSION='cbf7f39277b1009e3312615d1ddae8d6d77dc3c9'
        OPENWRT_VERSION='cbf7f39277b1009e3312615d1ddae8d6d77dc3c9'
    fi
...
# prplos latest-24.10_2025-10-20
OPENWRT_TOOLCHAIN_VERSION='41128852752a655c0ac97516fa215608466ac105'
OPENWRT_VERSION='41128852752a655c0ac97516fa215608466ac105'
