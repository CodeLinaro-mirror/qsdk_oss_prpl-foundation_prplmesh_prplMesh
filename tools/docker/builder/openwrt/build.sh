...
main() {
    ...
    if [[ " ${legacy_platforms[*]} " =~ " $TARGET_DEVICE " ]] ; then
        ...
        dbg "$TARGET_DEVICE non-legacy platform, building on prplOS latest-24.10_2025-10-08 UPDK-9.2.0"
        OPENWRT_TOOLCHAIN_VERSION='b48c57223ec30ce99c2045bf40f74a2219847f13'
        OPENWRT_VERSION='b48c57223ec30ce99c2045bf40f74a2219847f13'
    fi
...
# prplos latest-24.10_2025-10-08
OPENWRT_TOOLCHAIN_VERSION='b48c57223ec30ce99c2045bf40f74a2219847f13'
OPENWRT_VERSION='b48c57223ec30ce99c2045bf40f74a2219847f13'
