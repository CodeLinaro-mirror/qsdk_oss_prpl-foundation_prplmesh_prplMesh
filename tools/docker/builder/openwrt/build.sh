...
main() {
    ...
    if [[ " ${legacy_platforms[*]} " =~ " $TARGET_DEVICE " ]] ; then
        ...
        dbg "$TARGET_DEVICE non-legacy platform, building on prplOS latest-24.10 (pinned commit)"
        OPENWRT_TOOLCHAIN_VERSION='fc21c16f830d5c05171fd7395156161e610347ab'
        OPENWRT_VERSION='fc21c16f830d5c05171fd7395156161e610347ab'
    fi
...
# prplos latest-24.10 (pinned commit)
OPENWRT_TOOLCHAIN_VERSION='fc21c16f830d5c05171fd7395156161e610347ab'
OPENWRT_VERSION='fc21c16f830d5c05171fd7395156161e610347ab'
