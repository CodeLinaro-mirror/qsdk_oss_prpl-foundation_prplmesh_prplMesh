...
main() {
    ...
    if [[ " ${legacy_platforms[*]} " =~ " $TARGET_DEVICE " ]] ; then
        ...
        dbg "$TARGET_DEVICE non-legacy platform, building on prplOS latest-24.10_2026-02-24"
        OPENWRT_TOOLCHAIN_VERSION='e0617c0be261750c827aba5c3eba00616826beb1'
        OPENWRT_VERSION='e0617c0be261750c827aba5c3eba00616826beb1'
    fi
...
# prplos latest-24.10_2026-02-24
OPENWRT_TOOLCHAIN_VERSION='e0617c0be261750c827aba5c3eba00616826beb1'
OPENWRT_VERSION='e0617c0be261750c827aba5c3eba00616826beb1'
