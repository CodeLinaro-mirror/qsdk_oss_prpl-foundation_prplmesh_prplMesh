...
main() {
    ...
    if [[ " ${legacy_platforms[*]} " =~ " $TARGET_DEVICE " ]] ; then
        ...
        dbg "$TARGET_DEVICE non-legacy platform, building on prplOS mainline-24.10_2026-06-08"
        OPENWRT_TOOLCHAIN_VERSION='544f8a3e0be06de4ac212ec879988413dd82826d'
        OPENWRT_VERSION='544f8a3e0be06de4ac212ec879988413dd82826d'
    fi
...
# prplos mainline-24.10_2026-06-08
OPENWRT_TOOLCHAIN_VERSION='544f8a3e0be06de4ac212ec879988413dd82826d'
OPENWRT_VERSION='544f8a3e0be06de4ac212ec879988413dd82826d'
