...
main() {
    ...
    if [[ " ${legacy_platforms[*]} " =~ " $TARGET_DEVICE " ]] ; then
        ...
        dbg "$TARGET_DEVICE non-legacy platform, building on prplOS latest-24.10_2026-02-24 - ATH13.1+WPS fix + QCA patch open files"
        OPENWRT_TOOLCHAIN_VERSION='3f42169081ac616bf03da68fd02ae63fe78017b1'
        OPENWRT_VERSION='3f42169081ac616bf03da68fd02ae63fe78017b1'
    fi
...
# prplos latest-24.10_2026-02-24 - ATH13.1
OPENWRT_TOOLCHAIN_VERSION='3f42169081ac616bf03da68fd02ae63fe78017b1'
OPENWRT_VERSION='3f42169081ac616bf03da68fd02ae63fe78017b1'
