...
main() {
    ...
    if [[ " ${legacy_platforms[*]} " =~ " $TARGET_DEVICE " ]] ; then
        ...
        dbg "$TARGET_DEVICE non-legacy platform, building on prplOS latest-24.10_2026-07-08 - QCA bSTA fixes"
        OPENWRT_TOOLCHAIN_VERSION='17ed004537446d21651e68fdd14dbc7567828cb3'
        OPENWRT_VERSION='17ed004537446d21651e68fdd14dbc7567828cb3'
    fi
