...
main() {
    ...
    if [[ " ${legacy_platforms[*]} " =~ " $TARGET_DEVICE " ]] ; then
        ...
        dbg "$TARGET_DEVICE non-legacy platform, building on prplOS latest-24.10_2025-12-11"
        OPENWRT_TOOLCHAIN_VERSION='d8602b0e1ec901b0700149ca337ae12aa250492e'
        OPENWRT_VERSION='d8602b0e1ec901b0700149ca337ae12aa250492e'
    fi
...
# prplos latest-24.10_2025-11-21
OPENWRT_TOOLCHAIN_VERSION='d8602b0e1ec901b0700149ca337ae12aa250492e'
OPENWRT_VERSION='d8602b0e1ec901b0700149ca337ae12aa250492e'
