...
main() {
    ...
    if [[ " ${legacy_platforms[*]} " =~ " $TARGET_DEVICE " ]] ; then
        ...
        dbg "$TARGET_DEVICE non-legacy platform, building on prplOS dev_PPM-4076_latest-24.10"
        OPENWRT_TOOLCHAIN_VERSION='d65a6e5b81645ba8924b1e65d14493b5f68445c8'
        OPENWRT_VERSION='d65a6e5b81645ba8924b1e65d14493b5f68445c8'
    fi
...
# prplos dev_PPM-4076_latest-24.10
OPENWRT_TOOLCHAIN_VERSION='d65a6e5b81645ba8924b1e65d14493b5f68445c8'
OPENWRT_VERSION='d65a6e5b81645ba8924b1e65d14493b5f68445c8'
