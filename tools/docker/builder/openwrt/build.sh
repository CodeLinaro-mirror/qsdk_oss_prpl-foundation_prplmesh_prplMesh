...
main() {
    ...
    if [[ " ${legacy_platforms[*]} " =~ " $TARGET_DEVICE " ]] ; then
        ...
        dbg "$TARGET_DEVICE non-legacy platform, building on prplOS mr 2249"
        OPENWRT_TOOLCHAIN_VERSION='28fd55e4b9aa69fdf924cec841a66a3d1f704726'
        OPENWRT_VERSION='28fd55e4b9aa69fdf924cec841a66a3d1f704726'
    fi
