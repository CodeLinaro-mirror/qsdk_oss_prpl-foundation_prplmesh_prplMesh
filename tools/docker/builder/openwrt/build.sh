...
main() {
    ...
    if [[ " ${legacy_platforms[*]} " =~ " $TARGET_DEVICE " ]] ; then
        ...
        dbg "$TARGET_DEVICE non-legacy platform, building on prplOS latest-24.10_2025-11-22"
        OPENWRT_TOOLCHAIN_VERSION='bf752ab98ede85045857c9a5267be78c8445efee'
        OPENWRT_VERSION='bf752ab98ede85045857c9a5267be78c8445efee'
    fi
