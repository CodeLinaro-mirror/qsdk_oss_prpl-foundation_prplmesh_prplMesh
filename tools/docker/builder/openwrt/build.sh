...
main() {
    ...
    if [[ "haze" == "$TARGET_DEVICE" ]] ; then
        ...
        dbg "Freedom platform, prplOS 23.05"
        OPENWRT_TOOLCHAIN_VERSION='e333cb1c7a7d92fbb81cf906b031f43a790e69d2'
        OPENWRT_VERSION='e333cb1c7a7d92fbb81cf906b031f43a790e69d2'
    else
