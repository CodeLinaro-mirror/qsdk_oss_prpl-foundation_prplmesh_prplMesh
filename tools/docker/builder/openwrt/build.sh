...
main() {
    ...
    if [[ " ${legacy_platforms[*]} " =~ " $TARGET_DEVICE " ]] ; then
        ...
        dbg "$TARGET_DEVICE non-legacy platform, building on prplOS latest-24.10_2026-03-18"
        OPENWRT_TOOLCHAIN_VERSION='ddf851dcf30680d47dd50291b9d803d57445a761'
        OPENWRT_VERSION='ddf851dcf30680d47dd50291b9d803d57445a761'
    fi
...
# prplos latest-24.10_2026-03-18
OPENWRT_TOOLCHAIN_VERSION='ddf851dcf30680d47dd50291b9d803d57445a761'
OPENWRT_VERSION='ddf851dcf30680d47dd50291b9d803d57445a761'
