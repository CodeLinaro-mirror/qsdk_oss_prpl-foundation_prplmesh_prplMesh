...
main() {
    ...
    if [[ " ${legacy_platforms[*]} " =~ " $TARGET_DEVICE " ]] ; then
        ...
        dbg "$TARGET_DEVICE non-legacy platform, building on prplOS latest-24.10_2026-02-01 UPDK-9.2.4"
        OPENWRT_TOOLCHAIN_VERSION='82f6c11814bbdfa9f63094f0a536a01b88acd715'
        OPENWRT_VERSION='82f6c11814bbdfa9f63094f0a536a01b88acd715'
    fi
...
# prplos latest-24.10_2026-02-01
OPENWRT_TOOLCHAIN_VERSION='82f6c11814bbdfa9f63094f0a536a01b88acd715'
OPENWRT_VERSION='82f6c11814bbdfa9f63094f0a536a01b88acd715'
