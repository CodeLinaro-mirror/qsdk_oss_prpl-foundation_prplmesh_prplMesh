...
main() {
    ...
    if [[ " ${legacy_platforms[*]} " =~ " $TARGET_DEVICE " ]] ; then
        ...
        OPENWRT_TOOLCHAIN_VERSION='eaf88a962870cdd448ab1abc7244ace68bcbfc90'
        OPENWRT_VERSION='eaf88a962870cdd448ab1abc7244ace68bcbfc90'
    fi
...
# prplos latest-24.10_2026-01-12
OPENWRT_TOOLCHAIN_VERSION='eaf88a962870cdd448ab1abc7244ace68bcbfc90'
OPENWRT_VERSION='eaf88a962870cdd448ab1abc7244ace68bcbfc90'
