...
main() {
    ...
    if [[ " ${legacy_platforms[*]} " =~ " $TARGET_DEVICE " ]] ; then
        ...
        dbg "$TARGET_DEVICE non-legacy platform, building on prplOS mainline-24.10_2026-04-01"
        OPENWRT_TOOLCHAIN_VERSION='e86a98f2ccdc9c67636fa609b360c396dd8d1310'
        OPENWRT_VERSION='e86a98f2ccdc9c67636fa609b360c396dd8d1310'
    fi
...
# prplos mainline-24.10_2026-04-01
OPENWRT_TOOLCHAIN_VERSION='e86a98f2ccdc9c67636fa609b360c396dd8d1310'
OPENWRT_VERSION='e86a98f2ccdc9c67636fa609b360c396dd8d1310'
