...
main() {
    ...
    if [[ " ${legacy_platforms[*]} " =~ " $TARGET_DEVICE " ]] ; then
        ...
        dbg "$TARGET_DEVICE non-legacy platform, building on prplOS mainline-23.05_2025-12-12"
        OPENWRT_TOOLCHAIN_VERSION='c9582d754287b46977232afab0ea0d7ba56f2006'
        OPENWRT_VERSION='c9582d754287b46977232afab0ea0d7ba56f2006'
    fi
