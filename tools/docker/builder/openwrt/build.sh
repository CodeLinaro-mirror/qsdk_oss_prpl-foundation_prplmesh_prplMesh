...
main() {
    ...
    if [[ "haze" == "$TARGET_DEVICE" ]] ; then
        ...
        dbg "Freedom platform, prplOS mainline 3.2 + vlanid patch + addvapintf patch + 6GHz ep remove + hostapd segf fix"
        OPENWRT_TOOLCHAIN_VERSION='329f8dfc50edfe28dda42e216e1537ecec5172c3'
        OPENWRT_VERSION='329f8dfc50edfe28dda42e216e1537ecec5172c3'
    else
