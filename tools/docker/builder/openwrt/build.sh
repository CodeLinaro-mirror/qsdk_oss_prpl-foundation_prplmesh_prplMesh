...
main() {
    ...
    if [[ " ${legacy_platforms[*]} " =~ " $TARGET_DEVICE " ]] ; then
        ...
        dbg "$TARGET_DEVICE non-legacy platform, building on prplOS latest-24.10_2026-04-14 - bsta"
        OPENWRT_TOOLCHAIN_VERSION='db09f9c054582894a7ea3330f2ec72baa24b1fc9'
        OPENWRT_VERSION='db09f9c054582894a7ea3330f2ec72baa24b1fc9'
    fi
