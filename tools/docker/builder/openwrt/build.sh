...
main() {
    ...
    if [[ " ${legacy_platforms[*]} " =~ " $TARGET_DEVICE " ]] ; then
        ...
        dbg "$TARGET_DEVICE non-legacy platform, building on prplOS latest-24.10_2026-05-26"
        OPENWRT_TOOLCHAIN_VERSION='c4bf02718373f4310e9d4a2ef19414d74e940fe5'
        OPENWRT_VERSION='c4bf02718373f4310e9d4a2ef19414d74e940fe5'
    fi
...
# prplos latest-24.10_2026-05-26
OPENWRT_TOOLCHAIN_VERSION='c4bf02718373f4310e9d4a2ef19414d74e940fe5'
OPENWRT_VERSION='c4bf02718373f4310e9d4a2ef19414d74e940fe5'
