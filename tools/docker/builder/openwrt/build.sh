...
main() {
    ...
    if [[ " ${legacy_platforms[*]} " =~ " $TARGET_DEVICE " ]] ; then
        ...
        dbg "$TARGET_DEVICE non-legacy platform, building on prplOS latest-24.10_2026-01-05"
        OPENWRT_TOOLCHAIN_VERSION='4f796b4badd208455e742a7fa87ac30e4fc605f1'
        OPENWRT_VERSION='4f796b4badd208455e742a7fa87ac30e4fc605f1'
    fi
