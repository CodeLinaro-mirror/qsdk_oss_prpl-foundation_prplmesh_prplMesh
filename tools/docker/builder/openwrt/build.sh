...
main() {
    ...
    if [[ "haze" == "$TARGET_DEVICE" ]] ; then
        ...
        dbg "Freedom platform, prplOS mainline + pWHM latest"
        OPENWRT_TOOLCHAIN_VERSION='03de5f34b834b18b93e78acdb1b814b0198faad7'
        OPENWRT_VERSION='03de5f34b834b18b93e78acdb1b814b0198faad7'
    else
