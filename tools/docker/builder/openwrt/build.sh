...
main() {
    ...
    if [[ " ${legacy_platforms[*]} " =~ " $TARGET_DEVICE " ]] ; then
        ...
        dbg "$TARGET_DEVICE non-legacy platform, building on prplOS mainline-23.05_2025-12-22"
        OPENWRT_TOOLCHAIN_VERSION='3c902ac64730f9d546341e9b2b653814a3d3e2ec'
        OPENWRT_VERSION='3c902ac64730f9d546341e9b2b653814a3d3e2ec'
    fi
...
# prplos mainline-23.05_2025-11-23
OPENWRT_TOOLCHAIN_VERSION='3c902ac64730f9d546341e9b2b653814a3d3e2ec'
OPENWRT_VERSION='3c902ac64730f9d546341e9b2b653814a3d3e2ec'
