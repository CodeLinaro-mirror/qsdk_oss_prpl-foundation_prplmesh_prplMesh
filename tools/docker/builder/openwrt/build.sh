...
main() {
    ...
    if [[ " ${legacy_platforms[*]} " =~ " $TARGET_DEVICE " ]] ; then
        ...
        dbg "$TARGET_DEVICE non-legacy platform, building on prplOS latest-24.10_2026-02-10"
        OPENWRT_TOOLCHAIN_VERSION='df3f8813923bf00b0629165981f89f1ae2468c00'
        OPENWRT_VERSION='df3f8813923bf00b0629165981f89f1ae2468c00'
    fi
...
# prplos latest-24.10_2026-02-10
OPENWRT_TOOLCHAIN_VERSION='df3f8813923bf00b0629165981f89f1ae2468c00'
OPENWRT_VERSION='df3f8813923bf00b0629165981f89f1ae2468c00'
