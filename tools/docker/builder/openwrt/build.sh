...
main() {
    ...
    if [[ " ${legacy_platforms[*]} " =~ " $TARGET_DEVICE " ]] ; then
        ...
        dbg "$TARGET_DEVICE non-legacy platform, building on prplOS mainline-23.05 (stable-v4.0 25/08/2025)"
        OPENWRT_TOOLCHAIN_VERSION='1343b2238a8f877ee7637a301931eb6c06cfbc14'
        OPENWRT_VERSION='1343b2238a8f877ee7637a301931eb6c06cfbc14'
    fi
