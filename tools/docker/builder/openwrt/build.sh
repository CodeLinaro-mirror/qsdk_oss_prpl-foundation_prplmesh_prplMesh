...
main() {
	...
	*)
	...
	if [[ " ${legacy_platforms[*]} " =~ " $TARGET_DEVICE " ]]; then
		...
		dbg "$TARGET_DEVICE non-legacy platform, building on prplOS latest-24.10_2026-01-02"
		OPENWRT_TOOLCHAIN_VERSION='37785758eb4f168855c8b6bb29ac0378a84cc521'
		OPENWRT_VERSION='37785758eb4f168855c8b6bb29ac0378a84cc521'
	fi
