...
main() {
    ...
    if [[ " ${legacy_platforms[*]} " =~ " $TARGET_DEVICE " ]] ; then
        ...
        dbg "$TARGET_DEVICE non-legacy platform, building on prplOS mainline pre-amx"
        OPENWRT_TOOLCHAIN_VERSION='5f9884254097f51cf8875379842da7700e01a90d'
        OPENWRT_VERSION='5f9884254097f51cf8875379842da7700e01a90d'
    fi
