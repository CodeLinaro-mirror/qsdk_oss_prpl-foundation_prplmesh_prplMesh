...
main() {
    ...
    if [[ " ${legacy_platforms[*]} " =~ " $TARGET_DEVICE " ]] ; then
        ...
        dbg "$TARGET_DEVICE non-legacy platform, building on prplOS latest-24.10_2025-12-08"
        OPENWRT_TOOLCHAIN_VERSION='d3cd779d868eec2775362b58d84c34a0b4b94703'
        OPENWRT_VERSION='d3cd779d868eec2775362b58d84c34a0b4b94703'
    fi
...
# prplos latest-24.10_2025-12-08
OPENWRT_TOOLCHAIN_VERSION='d3cd779d868eec2775362b58d84c34a0b4b94703'
OPENWRT_VERSION='d3cd779d868eec2775362b58d84c34a0b4b94703'
