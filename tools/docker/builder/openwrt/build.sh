...
main() {
    ...
    if [[ " ${legacy_platforms[*]} " =~ " $TARGET_DEVICE " ]] ; then
		...
		dbg "OSP platform, build on mainline"
        OPENWRT_TOOLCHAIN_VERSION='6c0e3a53b33b8a249b91d9b4ebd5bd5a62a89db3'
        OPENWRT_VERSION='6c0e3a53b33b8a249b91d9b4ebd5bd5a62a89db3'
    fi
...
# prplos-v3.2.0
OPENWRT_TOOLCHAIN_VERSION='e6f96bb7dac01c3d258cfcaefa4ac6b1dae5285e'
OPENWRT_VERSION='e6f96bb7dac01c3d258cfcaefa4ac6b1dae5285e'
