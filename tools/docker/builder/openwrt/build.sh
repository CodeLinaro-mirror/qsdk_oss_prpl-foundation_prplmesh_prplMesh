...
main() {
    ...
    if [[ " ${legacy_platforms[*]} " =~ " $TARGET_DEVICE " ]] ; then
        ...
        dbg "$TARGET_DEVICE non-legacy platform, building on prplOS latest-24.10"
        OPENWRT_TOOLCHAIN_VERSION='739307e474a1c7bc93f47203d168dbad098edd23'
        OPENWRT_VERSION='739307e474a1c7bc93f47203d168dbad098edd23'
    fi
