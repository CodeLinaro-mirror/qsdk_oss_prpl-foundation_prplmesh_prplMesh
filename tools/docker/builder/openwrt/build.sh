...
main() {
    ...
    if [[ " ${legacy_platforms[*]} " =~ " $TARGET_DEVICE " ]] ; then
        ...
        dbg "$TARGET_DEVICE non-legacy platform, building on prplOS latest-24.10_2026-02-24 - ATH13.1 + baf upstep+ QCA WPS fix"
        OPENWRT_TOOLCHAIN_VERSION='a41604919d665394774b5dc9669c34357948c063'
        OPENWRT_VERSION='a41604919d665394774b5dc9669c34357948c063'
    fi
