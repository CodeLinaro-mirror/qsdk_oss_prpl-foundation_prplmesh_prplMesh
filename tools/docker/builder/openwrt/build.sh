...
main() {
    ...
    if [[ " ${legacy_platforms[*]} " =~ " $TARGET_DEVICE " ]] ; then
        ...
        dbg "Freedom platform, building on prplOS latest-24.10_2025-09-11"
        OPENWRT_TOOLCHAIN_VERSION='90f98b91e68fc22588b5bae182f296456ea913f1'
        OPENWRT_VERSION='90f98b91e68fc22588b5bae182f296456ea913f1'
    else
        dbg "$TARGET_DEVICE non-legacy platform, building on prplOS latest-24.10_2025-07-18, until UPDK-9.2.0 is merged"
        OPENWRT_TOOLCHAIN_VERSION='b4d6402be5fb18c70060a21128127791751c5ffb'
        OPENWRT_VERSION='b4d6402be5fb18c70060a21128127791751c5ffb'
    fi
...
# prplos latest-24.10_2025-09-11
OPENWRT_TOOLCHAIN_VERSION='90f98b91e68fc22588b5bae182f296456ea913f1'
OPENWRT_VERSION='90f98b91e68fc22588b5bae182f296456ea913f1'
