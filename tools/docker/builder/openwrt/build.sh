...
main() {
    ...
    if [[ " ${legacy_platforms[*]} " =~ " $TARGET_DEVICE " ]] ; then
        ...
        dbg "$TARGET_DEVICE non-legacy platform, building on prplOS dev_PPM-1912_latest-24.10 2026-06-11"
        OPENWRT_TOOLCHAIN_VERSION='7d8d253f9840744012a34bbd75ee6cea988f7710'
        OPENWRT_VERSION='7d8d253f9840744012a34bbd75ee6cea988f7710'
    fi
...
# prplos dev_PPM-1912_latest-24.10 2026-06-11
OPENWRT_TOOLCHAIN_VERSION='7d8d253f9840744012a34bbd75ee6cea988f7710'
OPENWRT_VERSION='7d8d253f9840744012a34bbd75ee6cea988f7710'
