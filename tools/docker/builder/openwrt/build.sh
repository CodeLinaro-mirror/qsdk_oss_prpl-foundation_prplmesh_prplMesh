...
main() {
    ...
    if [[ " ${legacy_platforms[*]} " =~ " $TARGET_DEVICE " ]] ; then
        ...
        dbg "$TARGET_DEVICE non-legacy platform, building on prplOS latest-24.10_2026-03-19 with feed-qca mr 82"
        OPENWRT_TOOLCHAIN_VERSION='3909a65418c2af18d41125d79635f1e4235d1064'
        OPENWRT_VERSION='3909a65418c2af18d41125d79635f1e4235d1064'
    fi
...
# prplos latest-24.10_2026-03-19 with feed-qca mr 82
OPENWRT_TOOLCHAIN_VERSION='3909a65418c2af18d41125d79635f1e4235d1064'
OPENWRT_VERSION='3909a65418c2af18d41125d79635f1e4235d1064'
