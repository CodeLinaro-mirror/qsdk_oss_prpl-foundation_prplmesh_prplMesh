...
main() {
    ...
    if [[ " ${legacy_platforms[*]} " =~ " $TARGET_DEVICE " ]] ; then
        ...
        dbg "$TARGET_DEVICE non-legacy platform, building on prplOS latest-24.10_2025-09-23 UPDK-9.2.0 + prio ebtables"
        OPENWRT_TOOLCHAIN_VERSION='f068b2325703df476f077c203535d22d0b8ab856'
        OPENWRT_VERSION='f068b2325703df476f077c203535d22d0b8ab856'
    fi
