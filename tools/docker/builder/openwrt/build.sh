...
main() {
    ...
    if [[ " ${legacy_platforms[*]} " =~ " $TARGET_DEVICE " ]] ; then
        ...
        dbg "$TARGET_DEVICE non-legacy platform, building on prplOS latest-24.10_2026-04-30"
        OPENWRT_TOOLCHAIN_VERSION='5c40750b6c1333cab9f00d1993843f4edd2839da'
        OPENWRT_VERSION='5c40750b6c1333cab9f00d1993843f4edd2839da'
    fi
...
# prplos latest-24.10_2026-04-30
OPENWRT_TOOLCHAIN_VERSION='5c40750b6c1333cab9f00d1993843f4edd2839da'
OPENWRT_VERSION='5c40750b6c1333cab9f00d1993843f4edd2839da'
