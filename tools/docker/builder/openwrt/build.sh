...
main() {
    ...
    if [[ " ${legacy_platforms[*]} " =~ " $TARGET_DEVICE " ]] ; then
        ...
        dbg "$TARGET_DEVICE non-legacy platform, building on prplOS mainline-23.05_2025-10-30 UPDK-9.1.100"
        OPENWRT_TOOLCHAIN_VERSION='a488d0db2825f16829769b3625d215e7932aadcc'
        OPENWRT_VERSION='a488d0db2825f16829769b3625d215e7932aadcc'
    fi
...
# prplos mainline-23.05_2025-10-30
OPENWRT_TOOLCHAIN_VERSION='a488d0db2825f16829769b3625d215e7932aadcc'
OPENWRT_VERSION='a488d0db2825f16829769b3625d215e7932aadcc'
