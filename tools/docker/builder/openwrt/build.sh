...
main() {
    ...
    if [[ " ${legacy_platforms[*]} " =~ " $TARGET_DEVICE " ]] ; then
        ...
        dbg "$TARGET_DEVICE non-legacy platform, building on prplOS latest-24.10_2026-01-13"
        OPENWRT_TOOLCHAIN_VERSION='408942f9478b81afb529798473c884d90116516d'
        OPENWRT_VERSION='408942f9478b81afb529798473c884d90116516d'
    fi
...
# prplos latest-24.10_2026-01-13
OPENWRT_TOOLCHAIN_VERSION='408942f9478b81afb529798473c884d90116516d'
OPENWRT_VERSION='408942f9478b81afb529798473c884d90116516d'
