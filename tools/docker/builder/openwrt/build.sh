...
main() {
    ...
    if [[ " ${legacy_platforms[*]} " =~ " $TARGET_DEVICE " ]] ; then
        ...
        dbg "$TARGET_DEVICE non-legacy platform, building on prplOS latest-24.10_2026-09-19"
        OPENWRT_TOOLCHAIN_VERSION='b33668d07984f00d275efc33add121389a21cfe3'
        OPENWRT_VERSION='b33668d07984f00d275efc33add121389a21cfe3'
    fi
...
# prplos latest-24.10_2026-09-19
OPENWRT_TOOLCHAIN_VERSION='b33668d07984f00d275efc33add121389a21cfe3'
OPENWRT_VERSION='b33668d07984f00d275efc33add121389a21cfe3'
