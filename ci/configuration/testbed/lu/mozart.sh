...
ba-cli "IP.Interface.[Name == \"br-lan\"].IPv4Address.lan.IPAddress=192.168.50.2"
...
# Add a control interface to Mozart on the lan0 port
start_ssh_commands="
iptables -P INPUT ACCEPT
killall -9 dropbear
dropbear -F -T 10 -p192.168.50.2:22 &"
