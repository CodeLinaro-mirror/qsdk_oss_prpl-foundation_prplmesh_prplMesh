...
ba-cli "IP.Interface.[Name == \"br-lan\"].IPv4Address.[Alias == \"lan\"].IPAddress=192.165.100.120"
ba-cli "IP.Interface.[Name == \"br-guest\"].IPv4Address.[Alias == \"guest\"].IPAddress=192.165.200.120"
...
ba-cli "Device.Ethernet.Interface.[Alias == \"cpe-eth0_5\"].Enable=0"
ba-cli "Device.Ethernet.Interface.[Alias == \"cpe-eth0_5\"].Enable=1"
