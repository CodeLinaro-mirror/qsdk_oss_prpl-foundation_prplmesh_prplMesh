...
# TODO: remove
ba-cli "WiFi.AccessPoint.[Alias == \"wlan0.2\"].DefaultDeviceType = \"Guest\""
ba-cli "WiFi.AccessPoint.[Alias == \"wlan0.2\"].BridgeInterface=\"br-guest\""
ba-cli "WiFi.AccessPoint.[Alias == \"wlan1.2\"].DefaultDeviceType = \"Guest\""
ba-cli "WiFi.AccessPoint.[Alias == \"wlan1.2\"].BridgeInterface=\"br-guest\""
ba-cli "WiFi.AccessPoint.[Alias == \"wlan2.2\"].DefaultDeviceType = \"Guest\""
ba-cli "WiFi.AccessPoint.[Alias == \"wlan2.2\"].BridgeInterface=\"br-guest\""
ba-cli "WiFi.AccessPoint.[Alias == \"wlan4.2\"].DefaultDeviceType = \"Guest\""
ba-cli "WiFi.AccessPoint.[Alias == \"wlan4.2\"].BridgeInterface=\"br-guest\""
