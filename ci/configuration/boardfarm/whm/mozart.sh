...
ba-cli "Device.Ethernet.Interface.[Alias == \"cpe-lan0\"].Enable=0"
ba-cli "Device.Ethernet.Interface.[Alias == \"cpe-lan0\"].Enable=1"
...
# Add a control interface to Mozart on the lan0 port, with vlan 200
start_ssh_commands="
ip link add link lan0 name lan0.200 type vlan id 200
ip addr add 192.168.200.180/24 dev lan0.200
ip link set up dev lan0.200
iptables -P INPUT ACCEPT
killall -9 dropbear
dropbear -F -T 10 -p192.168.200.180:22 &"
